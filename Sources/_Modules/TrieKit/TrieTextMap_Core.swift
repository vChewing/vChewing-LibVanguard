...
extension VanguardTrie {
  ...
  public final class TextMapTrie {
    ...
    private let queryBuffer4Node: QueryBuffer<VanguardTrie.Trie.TNode?> = .init(maxCount: 2048)
    private let queryBuffer4Nodes: QueryBuffer<[VanguardTrie.Trie.TNode]> = .init(maxCount: 2048)
    private let queryBuffer4NodeIDs: QueryBuffer<[Int]> = .init(maxCount: 2048)
