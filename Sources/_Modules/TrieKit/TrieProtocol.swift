...
public protocol VanguardTrieProtocol {
  ...
  func getNodeIDs(keyArray: [String], filterType: EntryType, partiallyMatch: Bool) -> Set<String>
  func getNode(nodeID: String) -> TNode?
...
extension VanguardTrieProtocol {
  ...
  func getNodeIDs(
    ...
    var result = [Int: (keys: [String], ids: Set<String>)]()
