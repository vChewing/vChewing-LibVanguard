...
public enum LatinKeyboardMappings: String, CaseIterable {
  ...
  public var mapTableDarwin: [UInt16: (String, String)] {
    ...
    case .azerty, .azertyFrench: Self.dictAzerty
    case .qwertz, .qwertzGerman: Self.dictQwertz
    case .colemak: Self.dictColemak
    case .dvorak, .dvorakQwertyCMD: Self.dictDvorak
    case .dvorakLeft: Self.dictDvorakLeft
    case .dvorakRight: Self.dictDvorakRight
    }
  }
