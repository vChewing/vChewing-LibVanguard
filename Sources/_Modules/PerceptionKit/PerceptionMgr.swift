...
// MARK: - PerceptionManager

public struct PerceptionManager {
  // MARK: Lifecycle
...
extension PerceptionManager {
  ...
  public func getSuggestion(
    ...
    let isSingleCharUnigram = isUnigramKey && isSpanLengthOne(key: keyCells.last?.description ?? "")
  ...
  public mutating func memorizePerception(
