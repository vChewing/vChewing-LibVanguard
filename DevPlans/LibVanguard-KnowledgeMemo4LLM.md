...
> 最後更新：2026-07-03（Phase 101: 徹底重寫 `vChewing-HomePage.io` 的 `manual/preferences.md`，涵蓋全部 12 個偏好設定頁面逐項說明＋舊版 AppKit 介面差異。純文件任務，無 Swift 程式碼變更與編譯。）
...
> ⚠️ **注意**: 本文檔需要定期更新以反映最新程式碼狀態。最後更新：Phase 101（2026-07-03）。
