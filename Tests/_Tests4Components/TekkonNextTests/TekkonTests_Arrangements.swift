...
struct TekkonTestsKeyboardArrangmentsDynamic {
  ...
  @Test("[TekkonNext] DynamicKeyLayouts", arguments: Array(Parser.allCases.filter(\.isDynamic).enumerated()))
  func testDynamicKeyLayouts(_ parserEnumerated: EnumeratedSequence<[Parser]>.Element) async throws {
